...
function Statement() {
  ...
  return (
    <div className="flex flex-col items-center space-y-10 font-bold text-center text-black">
      ...
      {/* gradient statement */}
      <h1 
        className='md:text-7xl text-5xl'>Create videos with <span className="bg-gradient-to-r from-custom-blue to-custom-red 
          inline-block text-transparent bg-clip-text">text prompts</span>
      </h1>

      {/* description */}
      <div className='md:text-2xl text-md px-10'>
      ...
      <div id="video container" className='flex flex-col items-center pb-20'>
        <video className='rounded-3xl w-4/5 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.5)]' autoPlay loop muted>
